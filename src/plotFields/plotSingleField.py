...
field = extract_field("fluxgate_2025-11-27_16.26.20.csv", "fluxgate_2025-11-27_16.41.15.csv")

fig, ax = plt.subplots()

# ax.scatter(get_dfcol(field, 0), get_dfcol(field, 1), label='Bx (uT)')
ax.scatter(get_dfcol(field, 0), get_dfcol(field, 2), label='By (uT)', marker='.')
# ax.scatter(get_dfcol(field, 0), get_dfcol(field, 3), label='Bz (uT)')
